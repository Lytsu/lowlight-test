...
const config = {
    ...
    projectName: "lowlight-test", // Usually your repo name.
    plugins: [
        [
        ...
        [
            ...
            ({
                docs: {
                    ...
                    editUrl: "https://github.com/Lytsu/lowlight-test/edit/main/",
                    routeBasePath: "/",
    ...
    /** @type {import('@docusaurus/preset-classic').ThemeConfig} */
        ...
        announcementBar: {
            id: "support_us",
            content: '这是微光 Lowlight 的测试版本网站，不建议在正式环境中实际使用。',
        ...
        navbar: {
            ...
            items: [
                ...
                {
                    href: "https://github.com/Lytsu/lowlight-test",
                    position: "right",
